...
public final class ActivityAddPlacesBinding implements ViewBinding {
  ...
  private ActivityAddPlacesBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAdd,
  ...
  public static ActivityAddPlacesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddPlacesBinding((ConstraintLayout) rootView, btnAdd, etDescription,
