...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main,
      @NonNull Button splashBtn, @NonNull ImageView splashImage, @NonNull ImageView splashLogo) {
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.splashBtn;
      Button splashBtn = ViewBindings.findChildViewById(rootView, id);
      if (splashBtn == null) {
        break missingId;
      }
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, main, splashBtn, splashImage,
          splashLogo);
    }
