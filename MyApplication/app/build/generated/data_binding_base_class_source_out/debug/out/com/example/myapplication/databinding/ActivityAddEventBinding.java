...
public final class ActivityAddEventBinding implements ViewBinding {
  ...
  private ActivityAddEventBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAdd,
  ...
  public static ActivityAddEventBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddEventBinding((ConstraintLayout) rootView, btnAdd, etDescription,
