...
public final class ActivityUpdateHotelBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityUpdateHotelBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnDelete,
  ...
  @NonNull
  public static ActivityUpdateHotelBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUpdateHotelBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_update_hotel, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUpdateHotelBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUpdateHotelBinding((ConstraintLayout) rootView, btnDelete, btnUpdate,
