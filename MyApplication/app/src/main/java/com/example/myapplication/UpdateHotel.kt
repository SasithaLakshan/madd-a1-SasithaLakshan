...
class UpdateHotel : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseRef = FirebaseDatabase.getInstance().reference.child("Hotels") //get reference to the database and navigate to the "Hotels" node then navigate to the child node with the specific payment ID
        ...
        binding.btnUpdate.setOnClickListener {
            ...
            if(name.isEmpty() || description.isEmpty() || location.isEmpty()){
                ...
                val map = HashMap<String, Any>() //This map will be used to store the updated Hotel details before they are written to the database
